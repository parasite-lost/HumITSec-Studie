...
\onslide<2>{
	\begin{itemize}
		...
		\item höchstwahrscheinlich aktive Nutzer von E-Mail-Kommunikation
...
\begin{frame}[fragile]{Fragebogenverlauf}
	...
	in verschiedene Kategorien leichtfällt.
%
...
\begin{frame}{Fragebogenverlauf}
	\begin{tikzpicture}[mindmap,scale=0.7]
		...
		node[concept] (R) {$207$ \\ $100\%$}
			...
			\draw node[annotation,below,fill=gray!15] at (7,-3) {%
				\tikz[baseline=-0.5ex] \fill[goldenrod] (0,0) circle (2ex); betrachteter Ast

				\tikz[baseline=-0.5ex] \fill[red] (0,0) circle (2ex); Usability-Problem

				\tikz[baseline=-0.5ex] \fill[blue!70] (0,0) circle (2ex); kein Usability-Problem
			};
...
\begin{frame}{Fragebogenverlauf}
	\begin{tikzpicture}[mindmap,scale=0.7]
		...
		node[concept] {$207$ \\ $100\%$}
			...
			\only<1>{
				\draw node[annotation,below,fill=gray!30] (Q) at (-6,2.3) {Haben Sie derzeit Software für E-Mail-Kryptographie installiert?};
				\draw [concept connection] (R) edge (Q);
			}
			\only<2>{
...
\begin{frame}{Fragebogenverlauf}
	\begin{tikzpicture}[mindmap,scale=0.7]
		...
		node[concept] {$207$ \\ $100\%$}
			...
			\only<1>{
				\draw node[annotation,below,fill=gray!30] (Q) at (-6,2.3) {Hatten Sie schon einmal Software für E-Mail-Kryptographie installiert?};
				\draw [concept connection] (R) edge (Q);
			}
			\only<2>{
