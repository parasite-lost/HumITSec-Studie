...
\begin{frame}{Details}
	Unter den $17$ Befragte, die schon mindestens einmal eine verschlüsselte E-Mail versendet haben
...
\begin{frame}{Fragebogenverlauf}
	\begin{tikzpicture}[mindmap,scale=0.7]
		...
		node[concept] {$207$ \\ $100\%$}
			...
			\node[annotation,below,fill=gray!50,scale=1.3] at (4,-6.4) {Software für E-Mail-Kryptographie war schonmal installiert, sie wurde
			jedoch nicht bewusst entfernt.};
	\end{tikzpicture}
\end{frame}
...
\begin{frame}{Fragebogenverlauf}
	\begin{tikzpicture}[mindmap,scale=0.7]
		...
		node[concept] {$207$ \\ $100\%$}
			...
			\only<3>{
				\node[annotation,below,fill=gray!50,scale=1.3] at (4,-6.4) {Software für E-Mail-Kryptographie war noch nie installiert; es wurde schonmal versucht
